...
| "How long did this take?" | Built for this hackathon. 511 automated tests on the scientific logic, eighteen architecture decision records, and a defects file that lists what was wrong and what the numbers were. |
